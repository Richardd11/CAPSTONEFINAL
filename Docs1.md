...
Refactoring (Blue):
Standardized on a modal-only flow for logout across dashboards. Removed standalone logout confirmation pages in favor of setting a session flag and redirecting back to the dashboard to show the modal.
