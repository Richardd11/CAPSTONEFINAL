...
class SubjectControllerTest extends TestCase
{
    ...
    {
        // Test that the controller can be instantiated properly for integration testing
        $this->assertInstanceOf(SubjectController::class, $this->subjectController);
        $this->assertInstanceOf(SubjectService::class, $this->subjectService);
        $this->assertInstanceOf(SubjectDAO::class, $this->subjectDAO);
    }
