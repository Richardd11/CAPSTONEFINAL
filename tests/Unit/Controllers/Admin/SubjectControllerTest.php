...
class SubjectControllerTest extends TestCase
{
    ...
    /** @var MockObject&AuthService */
    private $mockAuthService;
    
    /** @var MockObject&SubjectService */
    private $mockSubjectService;
    ...
    {
        /** @var MockObject&AuthService $mockAuthService */
    ...
    public function it_should_display_subject_management_page()
    {
        ...
        // Test that the controller can be instantiated and mocks are properly set up
        $this->assertInstanceOf(SubjectController::class, $this->subjectController);
    }
