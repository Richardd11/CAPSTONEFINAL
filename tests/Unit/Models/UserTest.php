...
class UserTest extends TestCase
{
    ...
    /** @test */
    public function it_should_set_and_get_subject_info()
    {
        $user = new User();
        $subjectInfo = [
            'subject_code' => 'CS101',
        ...
        $result = $user->setSubjectInfo($subjectInfo);

        $this->assertInstanceOf(User::class, $result);
        $this->assertEquals($subjectInfo, $user->getSubjectInfo());
    }

    /** @test */
    public function it_should_return_null_for_empty_subject_info()
    {
        $user = new User();

        $this->assertNull($user->getSubjectInfo());
    }

    /** @test */
    public function it_should_set_null_subject_info()
    {
        $user = new User();
        $user->setSubjectInfo(['test' => 'data']);
        
        $result = $user->setSubjectInfo(null);
