...
function addAssignment() {
    ...
    .catch(error => {
        ...
        showErrorModal('An error occurred while adding the assignment.');
    });
}
...
function editAssignment(assignmentId) {
    ...
    .catch(error => {
        console.error('Error:', error);
        showErrorModal('An error occurred while fetching assignment data.');
    });
}
...
function updateAssignment() {
    ...
    .catch(error => {
        console.error('Error:', error);
        showErrorModal('An error occurred while updating the assignment.');
    });
}
